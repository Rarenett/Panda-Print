...
import ShippingTwo from "./pages/ShippingTwoPage"

import ProductDetailsMaterialPage from "./pages/ProductDetailsMaterialPage";
    ...
    <AuthProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            exact
            path='/product-details-material'
            element={<ProductDetailsMaterialPage />}
          />
          ...
          <Route exact path='/blog-details' element={<BlogDetailsPage />} />
                  <Route exact path='/shipping-policy' element={<ShippingTwo />} />
