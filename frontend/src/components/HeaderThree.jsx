...
const HeaderThree = () => {
  ...
  // ✅ MODIFICATION 1: Optimized scroll handler
  useEffect(() => {
    let ticking = false;
  ...
  return (
    <>
      ...
      {/* [Keep all the existing search box and mobile menu code unchanged until line 160...] */}
      ...
      >
        ...
        <div className='mobile-menu__inner'>
          <Link to='/' className='mobile-menu__logo'>
            <img src='assets/images/logo/pandalogo.png' alt='Logo' />
          </Link>
...
<header className={`header-middle style-two bg-color-neutral ${scroll ? 'header-scrolled' : ''}`}>
  <div className='container container-lg'>
    <nav className='header-inner flex-between'>
      {/* Enhanced Logo with Floating Bubbles */}
      <div className='logo'>
      ...
      {/* Logo End */}
            ...
            <div className='flex-align gap-16 search-section'>
                ...
                <ul className='header-top__right style-two flex-align flex-wrap'>
                  <li className='on-hover-item border-right-item border-right-item-sm-space has-submenu arrow-white'>
                    ...
                    <ul className='selectable-text-list on-hover-dropdown common-dropdown common-dropdown--sm max-h-200 scroll-sm px-0 py-8'>
                      {/* Keep your existing language options */}
                      <li>
                        <Link
                          to='#'
                  ...
                  <li className='on-hover-item border-right-item border-right-item-sm-space has-submenu arrow-white'>
                    ...
                    <ul className='selectable-text-list on-hover-dropdown common-dropdown common-dropdown--sm max-h-200 scroll-sm px-0 py-8'>
                      {/* Keep your existing currency options */}
                      <li>
                        <Link
                          to='#'
                          className='hover-bg-gray-100 text-gray-500 text-xs py-6 px-16 flex-align gap-8 rounded-0'
              ...
              {/* ✅ MODIFICATION 5: Enhanced search form with new classes */}
              <form
                action='#'
              ...
              >
                <div className='search-category style-two d-flex h-48 search-form d-sm-flex d-none enhanced-search'>
                  ...
                  >
                    ...
                    <option value={1}>Custom Signs</option>
                    <option value={2}>Banners & Flags</option>
                    <option value={3}>Business Cards</option>
                    <option value={4}>Vehicle Graphics</option>
                    <option value={5}>Trade Show Displays</option>
                    <option value={6}>Promotional Products</option>
                  </select>
            ...
            {/* ✅ MODIFICATION 6: Enhanced Header Icons with animations */}
            <div className='header-right flex-align d-lg-block d-none'>
              <div className='header-two-activities flex-align flex-wrap gap-32'>
                <button
                  type='button'
                  className='flex-align search-icon d-lg-none d-flex gap-4 item-hover-two header-icon-btn'
                >
                  <span className='text-2xl text-white d-flex position-relative item-hover__text'>
                    <i className='ph ph-magnifying-glass icon-animated' />
                ...
                >
                  <span className='text-2xl text-white d-flex position-relative item-hover__text'>
                    <i className='ph ph-user icon-animated' />
                    <span className='icon-ripple'></span>
                  </span>
                ...
                >
                  <span className='text-2xl text-white d-flex position-relative me-6 mt-6 item-hover__text'>
                    <i className='ph ph-heart icon-animated' />
                ...
                >
                  <span className='text-2xl text-white d-flex position-relative me-6 mt-6 item-hover__text'>
                    <i className='ph-fill ph-shuffle icon-animated' />
                    <span className='w-16 h-16 flex-center rounded-circle bg-main-two-600 text-white text-xs position-absolute top-n6 end-n4 badge-pulse'>
                      2
                    </span>
                    <span className='icon-ripple'></span>
                ...
                >
                  <span className='text-2xl text-white d-flex position-relative me-6 mt-6 item-hover__text'>
                    <i className='ph ph-shopping-cart-simple icon-animated' />
